                        ...
                        implements PQInterface<T>
{
    ...
    public void enqueue(T t) 
    {
        ...
        while ( i <= rear  && t.compareTo(A[i]) <= 0)  // while (still in the queue and new item 
            i = i + 1;                                 //        has lower or equal priority to
                                                       //        the current item)
                                                       //      move down the queue to find the
                                                       //      insertion point.
    ...
    {
        return rear == -1;  // No rear item? - Nothing in the queue
    }
    ...
    {
        return rear == A.length -1;  // All array elements used? - full queue
    }
    ...
    public T front()
    {
        if (rear == -1)    // if there's nothin in the queue
